...
<section class="my-20 container">
    @if ($articles->isEmpty())
        <div class="text-center h-[50vh] flex justify-center items-center" data-aos="fade-in">
            <h2 class="text-2xl font-semibold text-primary">Belum ada artikel yang tersedia.</h2>
        </div>
    @else
