<div x-data="tab">
    <h3 data-aos="fade-in" class="section-title text-center text-underline">Portfolio Kami</h3>

    <div class="flex max-lg:flex-wrap gap-4 justify-center items-center mb-16">
        <button data-aos="fade-right" wire:click="setCategory(null)"
        ...
        @foreach ($categories as $key => $category)
            <button data-aos="fade-right" data-aos-delay="{{ $key * 50 }}" wire:click="setCategory({{ $category->id }})"
                class="px-2.5 py-0.5 text-sm rounded-full bg-secondary hover:bg-primary uppercase font-medium hover:text-white"
    ...
    <div data-aos="fade-in" data-aos-delay="200" class="portfolio_slider splide">
