        ...
        <div class="flex max-lg:flex-col justify-between">
            <div class="max-lg:mb-8">
                ...
                <div class="relative mt-4">
                    ...
                    <button type="button" class="absolute end-1.5 bottom-1.5 text-white bg-brand hover:bg-brand-strong box-border border border-transparent focus:ring-4 focus:ring-brand-medium shadow-xs font-medium leading-5 rounded text-xs focus:outline-none">
